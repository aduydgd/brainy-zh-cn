...
'properties_manage_htaccess_login' => '登录',
...
'properties_manage_htaccess_set_ok' => '通过 .htpasswd 添加的授权',
...
'properties_manage_htaccess_access_ip_list_d' => '拒绝 IP：',
...
'properties_edittimedenyVZ' => 'OpenVZ 虚拟化不支持时间更改',
    ...
    'properties_htaccess_ip_allow' => '!!!注意，访问面板将针对此字段中列出的 ip，其他 ip 访问将被拒绝。<br> 编辑允许的 IP 列表 (htaccess) 以访问 BrainyCP 管理面板.在新行中指定由分隔符`;` 或`,` 或`space`分隔',
    'properties_htaccess_ip_deny' => '编辑拒绝 IP 列表 (htaccess) 以访问 BrainyCP 管理面板。在新行中指定由分隔符`;` 或`,` 或`space`分隔',
    'properties_pathedittemplate' => 'index.html 模板的路径：/usr/local/brainycp',
   ...
   'properties_keyauth_btn_gen' => '生成密钥',
    ...
    'properties_server_port_busy' => '您选择的端口正忙',
    ...
    'properties_sendFromWho' => '电子邮件来自',
    'properties_sendReplyTo' => '回复电子邮件',
    'properties_sendFromWhoName' => '你的名字来自谁',
    'properties_sendReplayToName' => '回复你的名字',
    ...
    'properties_portbrainy' => 'Port Brainy',
    'properties_portbrainyssl' => 'Brainy SSL 端口',
    ...
    'properties_webpanel_brainy' => '通过域访问智能面板，指定域名，无端口',
