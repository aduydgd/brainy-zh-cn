...
(function(root, factory) {
	...
	elFinder.prototype.i18.zh-CN = {
		...
		messages   : {
			...
			'errQuota'              : 'Превышена доступная квота.',
			...
			'errLib64'             : 'Удаление lib64, или bin Запрещено',//BRAINY
			...
			'ntfpreupload': 'Проверка имени загруженного файла', // from v2.1 added 31.11.2015
